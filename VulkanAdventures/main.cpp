...
void DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMesenger, const VkAllocationCallbacks* pAllocator)
{
	auto func = (PFN_vkDestroyDebugUtilsMessengerEXT) vkGetInstanceProcAddr(instance, "vkDestroyDebugUtilsMessengerEXT");
	if (func != nullptr) func(instance, debugMesenger, pAllocator);
}
...
private:
	...
	void createLogicalDevice()
	{
		...
		vkGetDeviceQueue(device, indicies.graphicsFamily.value(), 0, &presentQueue);
	...
	void createSyncObjects()
	{
		...
		if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphore) || vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSemaphore) || vkCreateFence(device, &fenceInfo, nullptr, &inFlightFence) != VK_SUCCESS)
		{
